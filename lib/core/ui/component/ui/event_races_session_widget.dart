    ...
    return Column(
      children: [
        ListView.builder(
          ...
          itemCount: widget.sessionModel?.sessions?.length,
          itemBuilder: (context, index) {
            return CardWidget(
                childLeft: Column(
                  children: [
                    ...
                    ButtonWidget(
                        ...
                        onPressed: () async {
                          setState(() {
                            widget.sessionModel!.sessions?[index]?.settings
                                ?.removeLast();
                          });
                        }),
                  ],
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        TextWidget(
                          text: getSessionType(
                              widget.sessionModel?.sessions?[index]?.type),
                          style: Style.subtitle,
                        ),
                      ],
                    ),
                    if (widget.sessionModel?.sessions?[index] == null ||
                        widget.sessionModel?.sessions?[index]?.settings ==
                            null ||
                        widget.sessionModel?.sessions?[index]?.settings
                                ?.isEmpty ==
                ...
                childRight: ButtonWidget(
                    ...
                    onPressed: () {
                      setState(() {
                        widget.sessionModel?.sessions?.removeAt(index);
                      });
                    }),
                ready: true);
          },
