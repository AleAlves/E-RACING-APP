...
class EventManageRaceListView extends StatefulWidget {
  final EventManageViewModel viewModel;

  const EventManageRaceListView(this.viewModel, {Key? key}) : super(key: key);

  @override
  _EventManageRaceListViewState createState() =>
      _EventManageRaceListViewState();
}

class _EventManageRaceListViewState extends State<EventManageRaceListView>
