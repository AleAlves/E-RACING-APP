...
class EventCreateOptionsView extends StatefulWidget {
  final EventCreateViewModel viewModel;

  const EventCreateOptionsView(this.viewModel, {Key? key}) : super(key: key);

  @override
  _EventCreateOptionsViewState createState() => _EventCreateOptionsViewState();
}

class _EventCreateOptionsViewState extends State<EventCreateOptionsView>
  ...
  Widget button() {
    return ButtonWidget(
      ...
      onPressed: () {
        widget.viewModel.setEventDate(_nameController.text);
      },
      label: "Next",
    );
  }
