...
class EventCreateBroadcastView extends StatefulWidget {
  final EventCreateViewModel viewModel;

  const EventCreateBroadcastView(this.viewModel, {Key? key}) : super(key: key);

  @override
  _EventCreateBroadcastViewState createState() =>
      _EventCreateBroadcastViewState();
}

class _EventCreateBroadcastViewState extends State<EventCreateBroadcastView>
