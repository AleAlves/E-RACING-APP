...
class LoginForgotPasswordView extends StatefulWidget {
  final LoginForgotPasswordViewModel viewModel;

  const LoginForgotPasswordView(this.viewModel, {Key? key}) : super(key: key);

  @override
  _LoginForgotPasswordViewState createState() =>
      _LoginForgotPasswordViewState();
}

class _LoginForgotPasswordViewState extends State<LoginForgotPasswordView>
